...
namespace EcomGr3
{
    public partial class frmSteam : Form
    {
        ...
        private void frmSteam_Load(object sender, EventArgs e)
        {
            LoadItems();
        }
        ...
        private void LoadItems()
        {
            ...
            {
                SqlCommand command = new SqlCommand("SELECT ID, ItemSteamimage, ItemSteamname, ItemSteamprice, ItemSteamstock  FROM tblSteam", connection);
                connection.Open();
                ...
                while (reader.Read())
                {
                    ...
                    byte[] imageData = (byte[])reader["ItemSteamimage"];
                    string itemName = reader["ItemSteamname"].ToString();
                    string itemPrice = reader["ItemSteamprice"].ToString();
                    int stock = (int)reader["ItemSteamstock"];
