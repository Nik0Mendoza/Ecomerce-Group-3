        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            foreach (var control in flowLayoutPanel1.Controls)
            {
                ...
                if (pictureBox != null && pictureBox.BorderStyle == BorderStyle.Fixed3D)
                {
                    ...
                    using (SqlConnection connection = new SqlConnection(connectionString))
                    {
                        SqlCommand command = new SqlCommand("INSERT INTO tblCart (accountID, productID, itemID, productName, stock, gameID) VALUES (@accountID, 12, @itemID, @productName, 1, @gameID)", connection);
